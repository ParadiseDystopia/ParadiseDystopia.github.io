...
local panorama_events = require "panorama_events"
...
local function saveConfig()
	database.save(CONFIG_KEY, config)
end
local function loadConfig()
	local _config = database.load(CONFIG_KEY)
	if _config == nil then
...
local panoramaBridge = {
	...
	saveFilters = function(type, filters)
		filters = utils.json_decode(filters)
		if filters == nil then
			return
		end
		local oldTags = ""
